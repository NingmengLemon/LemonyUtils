'''
A simple module for WBI Sign of Bilibili
...
__all__ = ["CachedWbiManager", "sign_wbi", "get_wbi_keys"]
...
class CachedWbiManager:
    ...
    def sign_wbi(self, params):
        ...
        return sign_wbi(params=params, img_key=img_key, sub_key=sub_key)
...
if __name__ == "__main__":
    ...
    signed_params = manager.sign_wbi(
